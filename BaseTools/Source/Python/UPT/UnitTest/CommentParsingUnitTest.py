...
class ParseGenericCommentTest(unittest.TestCase):
    ...
    def testNormalCase1(self):
        ...
        self.assertFalse(not HelptxtObj)
...
class ParseDecPcdGenericCommentTest(unittest.TestCase):
    ...
    def testNormalCase1(self):
        ...
        self.assertFalse(not HelpTxt)
        self.assertFalse(PcdErr)
    ...
    def testNormalCase2(self):
        ...
        self.assertFalse(PcdErr.GetExpression())
        self.assertFalse(PcdErr.GetValidValueRange())
    ...
    def testNormalCase3(self):
        ...
        self.assertFalse(PcdErr.GetExpression())
        self.assertFalse(PcdErr.GetValidValue())
...
class ParseDecPcdTailCommentTest(unittest.TestCase):
    ...
    def testNormalCase1(self):
        ...
        self.assertFalse(not HelpStr)
        self.assertFalse(SupModeList)
    ...
    def testNormalCase2(self):
        ...
        (SupModeList, HelpStr) = \
            ParseDecPcdTailComment(TestCommentLinesList, 'UnitTest')
        self.assertFalse(not HelpStr)
        self.assertFalse(not SupModeList)
        self.assertEqual(HelpStr,
                         'hello world')
